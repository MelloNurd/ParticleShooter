...
{
    public class ParticleManagerJOBS : MonoBehaviour
    {
        public static ParticleManagerJOBS Instance { get; private set; }
        ...
        private void SpawnParticles()
        {
            ...
            var individualParticles = new ParticleSystem.Particle[ParticleManagerJOBS.Instance.NumberOfParticles];

            int activeCount = ParticleManagerJOBS.Instance.ParticleSystem.GetParticles(individualParticles);
            ...
            for (int i = 0; i < NumberOfParticles; i++)
            {
                ...
                ParticleManagerJOBS.Particles.Add(data);
